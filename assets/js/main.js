...
var Main = function () {
            ...
            onSelect: function(){
                ...
                function test(data) {
                    ...
                    Highcharts.chart('statistiques', {
                        ...
                        yAxis: {
                            title: {
                                text: 'Nombre de victimes des accidents'
                            },
                            min: 0
                        },
                        legend: {
                        ...
                        series: [{
                            type: 'area',
                            name: 'nombre de victimes des accidents',
                            data: data
                        }],
        ...
        search_input.attr('data-default', $(search_input).outerWidth()).focus(function () {
            ...
            if ($(this).val() == "") {
                ...
                $("body").click(function(e) {
                    if (e.target.id == "listeChampRecherche" || $(e.target).parents("#listeChampRecherche").length) {
                    }
                    else{
                        $("#champRecherche").val('');
                        $("#listeAddr").hide();
                        $('.sidebar-search').animate({
                            width: $(this).attr('data-default')
                        }, 200);
                    }
                }); 
    ...
    var runSearchInputDepart = function () {
        var search_input = $('.sidebar-search input');
        var search_button = $('.sidebar-search button');
        var search_form = $('.sidebar-search');
        search_input.attr('data-default', $(search_input).outerWidth()).focus(function () {
    ...
    var runSearchInputArrive = function () {
        var search_input = $('.sidebar-search input');
        var search_button = $('.sidebar-search button');
        var search_form = $('.sidebar-search');
        search_input.attr('data-default', $(search_input).outerWidth()).focus(function () {
